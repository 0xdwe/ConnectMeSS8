...
**Pass 4 begins.** Pass 4.1 (#052, Firebase Auth) shipped on 2026-05-21. Pass 4.2 in progress: #054, #055, #056, #057, #058, #062, #059 merged on 2026-05-24, plus the code half of #060 (explicit Firestore offline persistence). Remaining: device half of #060 (real-device cutover + two-device smoke + rules-denial evidence), #061 (closeout), and the pending #053 real-device verification gate.
...
- **#060 (device half)** — Production cutover verification + offline two-device smoke. Code half merged today (explicit Firestore offline persistence). Remaining: real-device cutover on at least one of {macOS, iOS Simulator, Android Emulator, physical device}, two-device smoke trace (online + offline-then-online), rules-denial evidence. iOS coverage required either here or via #053.
