...
Future<void> showUpdateConnectionModal(
  ...
  return showModalBottomSheet<void>(
    ...
    builder: (_) => UpdateConnectionModal(connection: connection),
  );
}
...
class UpdateConnectionModal extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<UpdateConnectionModal> createState() =>
      _UpdateConnectionModalState();
}
              ...
              try {
                ...
                if (context.mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Could not log update. Try again.'),
                    ),
                  );
                }
              }
