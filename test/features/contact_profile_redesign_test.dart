...
void main() {
  group('Contact Profile Redesign (#017)', () {
    ...
    testWidgets('profile shows History section with interactions', (
      tester,
    ) async {
    ...
    testWidgets('profile shows warm empty copy when no history', (
      tester,
    ) async {
      await pumpProfileScreen(tester, 'jessica');
    ...
    testWidgets('history rows render inline AI badge in the dense list', (
      tester,
    ) async {
    ...
    testWidgets(
      'empty history renders inside the History card with zero dividers',
      (tester) async {
        await pumpProfileScreen(tester, 'jessica');
